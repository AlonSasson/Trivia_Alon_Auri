...
public:
	...
	static std::string getSortedNames(const std::vector<std::string>& names); // function sorts and combines names into a string
	static std::vector<std::string> getNamesFromMap(const std::map<std::string, SOCKET> map); // gets the names of the users from the users map
